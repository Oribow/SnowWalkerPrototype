...
public class TKSwipeRecognizer : TKAbstractGestureRecognizer
{
    ...
    private bool trackTouchesStartedOutOfBounds = false;
    ...
    public bool TrackTouchesStartedOutOfBounds
    {
        set
        {
            trackTouchesStartedOutOfBounds = value;
            alwaysSendTouchesMoved = value;
        }
        get
        {
            return trackTouchesStartedOutOfBounds;
        }
    }
    ...
    internal override void touchesMoved(List<TKTouch> touches)
    {
        ...
        else if (trackTouchesStartedOutOfBounds)
        {
