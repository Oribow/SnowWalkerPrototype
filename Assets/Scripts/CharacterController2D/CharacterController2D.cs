...
namespace CC2D
{
    ...
    public class CharacterController2D : MonoBehaviour
    {
        ...
        public class CharacterCollisionState2D
        {
            ...
            public bool above;
            public RaycastHit2D aboveHit;
            public bool below;
            public RaycastHit2D belowHit;
            public bool becameGroundedThisFrame;
            public bool wasGroundedLastFrame;
            public bool movingDownSlope;
            public bool standOnToSteepSlope;
        ...
        public void recalculateDistanceBetweenRays()
        {
            ...
            // horizontal
            float colliderUseableHeight = boxCollider.size.y * Mathf.Abs(transform.localScale.y) - (2f * _skinWidth);
            _verticalDistanceBetweenRays = colliderUseableHeight / (totalHorizontalRays - 1);

            // vertical
            float colliderUseableWidth = boxCollider.size.x * Mathf.Abs(transform.localScale.x) - (2f * _skinWidth);
        ...
        /// </summary>
        void moveHorizontally(ref Vector3 deltaMovement, bool isJumping)
        {
            ...
            for (var i = 0; i < totalHorizontalRays; i++)
            {
                ...
                if (_raycastHit)
                {
                    ...
                    if (isGoingRight)
                    {
                        ...
                        collisionState.right = true;
                        collisionState.rightHit = _raycastHit;
                    }
                    else
                    {
                        deltaMovement.x += _skinWidth;
                        collisionState.left = true;
                        collisionState.leftHit = _raycastHit;
                    }
        ...
        bool handleHorizontalSlope(ref Vector3 deltaMovement, float angle, bool isJumping)
        {
            // disregard 90 degree angles (walls)
            if (Mathf.RoundToInt(angle) == 90)
                return false;
            ...
            {
                deltaMovement.x = 0;
                collisionState.standOnToSteepSlope = true;
            }
